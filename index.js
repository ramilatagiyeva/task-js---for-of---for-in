...
function GreenEye(arr) {
    let greenEyesArray = [];
    for (let i = 0; i < arr.length; i++) {
      if (arr[i].eyeColor === "green") {
        greenEyesArray.push(arr[i]);
      }
    }
    return greenEyesArray;
  }


   // 2) city i "San Francisco" olan obyektleri yeni arraye elave edib logda yazdiran function yaradin
   function SanFranciscoCities(arr) {
    let sanFranciscoArray = [];
    for (let i = 0; i < arr.length; i++) {
      if (arr[i].city === "San Francisco") {
        sanFranciscoArray.push(arr[i]);
      }
    }
    console.log(sanFranciscoArray);
    return sanFranciscoArray;
  }
  
SanFranciscoCities(users);


 // 3) departamenti Engineering i olanlari secib bir arraye elave edib loga cixaran func yazin 
 function EngineeringDepartment(arr) {
    let engineeringArray = [];
    for (let i = 0; i < arr.length; i++) { 
      if (arr[i].department === "engineering") {
        engineeringArray.push(arr[i]);
      }
    }
    console.log(engineeringArray);
  }
  EngineeringDepartment(users);
  ...
  function Gender(arr) {
    ...
    console.log("Male Array:", maleArray);
    console.log("Female Array:", femaleArray);
